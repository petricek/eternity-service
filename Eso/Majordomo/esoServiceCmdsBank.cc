 ...
 */
Err
Majordomo::DRCTimeForPayment(MsgField *dataInMsgFld)
{
 ...
 */
Err 
Majorodmo::DRCChallengeFromBank(MsgField *dataInMsgFld)
{
  GMessage *inMsg=NULL, *dataOutMsg=NULL, *outMsg=NULL, *bankAC=NULL;
  ACID bankACID;
 ...
 */
Err
Majordomo::DRCAnswerFromBank(MsgField *dataInMsgFld)
{
  GMessage *inMsg=NULL;
 ...
 */
Err
Majordomo::DRCTimeOutPayment(MsgField *dataInMsgFld)
{
  GMessage *inMsg=NULL, *dataOutMsg=NULL, *outMsg=NULL, *bankAC=NULL;
  ACID bankACID;
  Int request;
